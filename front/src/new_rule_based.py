...
with open("/root/feat_maxseats/level2-3-nlp-finalproject-nlp-04/temp/룰베이스드/simplified_data.json",
          "r",
          encoding="utf-8",
          ) as json_file:
...
if __name__ == "__main__":
    ...
    print(list_extend_questions_based_on_keywords(data_dict, jd, position="FE"))
